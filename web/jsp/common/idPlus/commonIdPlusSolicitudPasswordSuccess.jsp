<%--
    Document   : commonIdPlusSolicitudPasswordSuccess
    Created on : 24-08-2011, 10:01:40 AM
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/commonIdPlusSolicitudPasswordSuccess-3.0.0.js"></script>
    </head>
