<%--
    Document   : commonInscripcionCambioMencion
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/inscripcion/commonInscripcionCambioMencion-2.0.0.js"></script>
    </head>
    <body class="inner-body">
        <div id="hidden-input-div">
            <input type="hidden" id="keyDummy" name="keyDummy" value="<s:property value="key"/>"/>
        </div>
        <div id="confirmacion" title="<s:text name="message.title.confirmacion"/>">
        Si desea cambiarse de mención llame a Registro Curricular 
        Fonos: 27180741-27180742</div>
    </body>
</html>