<%-- 
    Document   : alumnoCertificadoRegular
...
<html lang="es">
    <head>
        ...
        src="/intranetv7/js/local/users/alumno/certificado/alumnoCertificadoAlumnoRegular-3.0.6.js"></script>
    </head>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table-striped">
                            <tr style="padding-top: 10px"><td>Tipo de Certificado</td><td>Alumno Regular</td></tr>
