<%-- 
    Document   : alumnoCertificadoInformeCalificaciones
...
<html lang="es">
    <head>
        ...
        <title>Certificación de Informe de Calificaciones</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        ...
        src="/intranetv7/js/local/users/alumno/certificado/alumnoCertificadoInformeCalificaciones-3.0.5.js"></script>
    </head>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table-striped">
                            <tr style="padding-top: 10px"><td>Tipo de Certificado</td><td>Informe de Calificaciones</td></tr>
