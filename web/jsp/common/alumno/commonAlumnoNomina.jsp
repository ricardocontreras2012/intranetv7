...
<html lang="es">
    <head>
        ...
        <title>Nómina de Alumnos de la Busqueda</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/alumno/commonAlumnoNomina-3.0.0.js"></script>
    </head>
    <body class="inner-body">
        ...
        <div class="data-tables-container">
            <table id="nomina-table" class="table table-striped table-bordered dataTable">
                ...
                <tbody>
                    <s:iterator value="#session.genericSession.getWorkSession(key).alumnoList" status="row">
                        <tr>
                            <td style="width: 15%; text-align: right"><a
                                    id="alumno_<s:property value="#row.count -1"/>"><s:property value="aluRut"/>-<s:property
                                        value="aluDv"/></a></td>
                            <td><s:property value="aluPaterno"/></td>
                            <td><s:property value="aluMaterno"/></td>
                            <td><s:property value="aluNombre"/></td>
                        </tr>
                    </s:iterator>
                </tbody>
            </table>
        </div>
        <form id="alumnos-form" action="#">
            <fieldset>
