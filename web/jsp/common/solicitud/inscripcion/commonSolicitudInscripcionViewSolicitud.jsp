<%--
    Document   : commonSolicitudInscripcionViewSolicitud
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/solicitud/inscripcion/commonSolicitudInscripcionViewSolicitud-3.0.0.js"></script>
    </head>
    <body class="inner-body">
        ...
        <button id="save-button" title="Grabar" type="button" class="btn btn-light" ><span class="fa fa-save" aria-hidden="true"></span>
            ...
            <s:form id="solicitud-form" action="#" method="post" theme="bootstrap">
            <table class="table">
                <%--tr>
                ...
                <tr>
                    ...
                    <td><s:property
                            value="#session.genericSession.getWorkSession(key).solicitud.aluCar.alumno.getNombre()"/> (<s:property value="#session.genericSession.getWorkSession(key).solicitud.aluCar.id.acaCodCar"/>)
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <s:if test="#session.genericSession.getWorkSession(key).solicitud.solResolucion == null">
                        <td><select id="resolucion" class="form-control"><option value=" "></option><option value="A">Aprobada</option><option value="AP">Aprobada Parcial</option><option value="R">Rechazada</option><option value="P">Pendiente</option></select></td>
                                </s:if>
                                <s:else>
                                    <s:if test="#session.genericSession.getWorkSession(key).solicitud.solResolucion ==\"A\"">
                            <td><select id="resolucion" class="form-control"><option value="A" selected>Aprobada</option><option value="AP">Aprobada Parcial</option><option value="R">Rechazada</option><option value="P">Pendiente</option></select></td>
                        </s:if>
                        <s:else>
                            <s:if test="#session.genericSession.getWorkSession(key).solicitud.solResolucion ==\"AP\"">
                                <td><select id="resolucion" class="form-control"><option value="A">Aprobada</option><option value="AP" selected>Aprobada Parcial</option><option value="R">Rechazada</option><option value="P">Pendiente</option></select></td>
                            </s:if>
                            <s:else>
                                <s:if test="#session.genericSession.getWorkSession(key).solicitud.solResolucion ==\"R\"">
                                    <td><select id="resolucion" class="form-control"><option value="A">Aprobada</option><option value="AP">Aprobada Parcial</option><option value="R" selected>Rechazada</option><option value="P">Pendiente</option></select></td>
                                </s:if>
                                <s:else>
                                    <td><select id="resolucion" class="form-control"><option value="A">Aprobada</option><option value="AP">Aprobada Parcial</option><option value="R">Rechazada</option><option value="P" selected>Pendiente</option></select></td>
                                </s:else>
                            </s:else>
                        </s:else>
                    </s:else>
                ...
                <tr>
                    ...
                    <td><textarea name="respuesta" id="respuesta" rows="3" cols="120" class="form-control"><s:property value="#session.genericSession.getWorkSession(key).solicitud.solRespuesta"/></textarea>
                    </td>
                </tr>
