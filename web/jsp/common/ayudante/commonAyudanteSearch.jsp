...
<html lang="es">
    <head>
        ...
        <title>Búsqueda de Ayudante</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/ayudante/commonAyudanteSearch-3.0.2.js"></script>
    </head>
    <body>
        <div class="container-fluid">
            <div class="title-div">
                <s:text name="label.title.consulta.ayudante"/>
            </div>
            ...
            <form id="ayudantes-form" accept-charset="UTF-8" action="#">
                <div class="form-row">
                    <div class="col-md-1">
