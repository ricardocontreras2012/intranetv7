...
<html lang="es">
    <head>
        ...
        <title>Nómina de Ayudantes de la Busqueda</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/ayudante/commonAyudanteNomina-3.0.0.js"></script>
    </head>
                    ...
                    <s:iterator value="#session.genericSession.getWorkSession(key).ayudanteList" status="row">
                        <tr>
                            <td style="width: 15%; text-align: right"><a
                                    id="ayudante_<s:property value="#row.count -1"/>"><s:property value="ayuRut"/>-<s:property
                                        value="ayuDv"/></a></td>
