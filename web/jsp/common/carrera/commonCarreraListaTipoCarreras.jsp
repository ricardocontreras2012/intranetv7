<%--
    Document   : commonCarreraListaTipoCarreras
    Created on : 09-10-2010, 02:33:48 PM
...
<html lang="es">
    <head>
        ...
        <title>Lista de Tipos de Carreras</title>
        ...
        src="/intranetv7/js/local/common/carrera/commonCarreraListaTipoCarreras-3.0.0.js"></script>
    </head>
                ...
                <table id="carreras-table" class="table table-striped">
                    ...
                    <tbody>
                        <s:iterator value="#session.genericSession.getWorkSession(key).mencionList" status="row">
                            <tr>
                                <td><a id="carrera_<s:property value="#row.count -1"/>"><s:property value="id.menCodCar"/></a>
                                </td>
                                <td><s:property value="getNombreCarrera()"/></td>
                            </tr>
                        </s:iterator>
                    </tbody>
                </table>
