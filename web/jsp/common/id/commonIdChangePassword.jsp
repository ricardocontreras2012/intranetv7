<%--
    Document   : commonIdChangePassword
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/id/commonIdChangePassword-3.0.3.min.js"></script>
    </head>
    <body>
        ...
        <div class="row d-flex justify-content-center">
            ...
            <div style="background-color: #00a499; color:white; border-radius: 20px; padding: 20px;">
                &compfn; Longitud de contraseña: mínimo 8 caracteres<br>
