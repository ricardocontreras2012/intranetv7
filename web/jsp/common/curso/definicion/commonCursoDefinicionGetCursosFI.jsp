                                        ...
                                        <div id="curso-modal-div">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Fecha Inicio</td>
                                                        <td><input type="text" id="inicio" name="inicio" class="form-control" maxlength="10" placeholder="dd/mm/yyyy"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Fecha Término</td>
                                                        <td><input type="text" id="termino" name="termino" class="form-control" maxlength="10" placeholder="dd/mm/yyyy"/></td>
                                                    </tr>
                                        ...
                                        <div id="curso-modify-modal-div">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>Fecha Inicio</td>
                                                        <td><input type="text" id="inicioId" name="inicioId" class="form-control" maxlength="10" placeholder="dd/mm/yyyy"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Fecha Término</td>
                                                        <td><input type="text" id="terminoId" name="terminoId" class="form-control" maxlength="10" placeholder="dd/mm/yyyy"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Diurno</td>
