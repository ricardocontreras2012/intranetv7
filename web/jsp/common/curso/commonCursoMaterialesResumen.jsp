<%--
    Document   : commonCursoMaterialesResumen
...
<html lang="es">
    <head>
        ...
        <title>Resumen de Materiales x Curso</title>
        ...
        src="/intranetv7/js/local/common/curso/commonCursoMaterialesResumen-3.0.0.js"></script>
    </head>
    <body class="inner-body">
        ...
        <form id="cursos-form" action="#" method="post">
                ...
                <table id="cursos-table" class="table table-striped table-bordered dataTable">
                    ...
                    <tbody>
                        <s:iterator value="#session.genericSession.getWorkSession(key).resumenCurso" status="row">
                            <tr>
                                <td style="width: 7%;text-align: right"><a
                                        id="curso_<s:property value="#row.count -1"/>"><s:property value="asign"/> <s:property
                                            value="elect"/></a></td>
            ...
            <div id="hidden-input-div">
                ...
                <input type="hidden" id="actionCall" name="actionCall" value="CommonMaterialConsultaMateriales"/>
            </div>
        </form>
    </body>
</html>