<%--
    Document   : commonCursoListaCursos
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/curso/commonCursoListaCursos-3.0.4.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            ...
            <s:if test="actionCall.startsWith('CommonMaterialHistoricoGetMaterialesCurso')">
                <s:text name="label.title.cursos.materiales"/>
            </s:if>
        </div>
                            ...
                            <tr>
                                <s:if test="actionCall != null && actionCall != \"\"">
                                    <td style="width: 10%;text-align: right"><a
                                            ...
                                            <s:property value="id.curElect"/></a>
                                    </td>
