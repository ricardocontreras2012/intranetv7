<%--
    Document   : commonEncuestaAyudanteCurso
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/encuesta/commonEncuestaCurso-3.0.1.js"></script>
    </head>
    <body class="inner-body">
        ...
        <form id="encuesta" action="#">
            <table class="table table-striped">
                ...
                <tbody>
                    <s:iterator value="#session.genericSession.getWorkSession(key).respEnctaAyu" status="row">
                        <tr>
                            <td style="width:5%; text-align: center"><s:property value="peaPreg"/>
                            </td>
                            <td style="width:75%">
                                <s:property value="peaDes"/>
                            </td>
            ...
            <table>
                <s:iterator value="#session.genericSession.getWorkSession(key).comentarioEncuestaAyudanteList" status="rowComen1">
                    <s:if test="ceaComen1 != null">
                        <tr>
                            <td><s:property value="ceaComen1"/></td>
                        </tr>
                    </s:if>
                </s:iterator>
            </table>
            ...
            <table>
                <s:iterator value="#session.genericSession.getWorkSession(key).comentarioEncuestaAyudanteList" status="rowComen2">
                    <s:if test="ceaComen2 != null">
                        <tr>
                            <td><s:property value="ceaComen2"/></td>
                        </tr>
                    </s:if>
                </s:iterator>
            </table>
