<%--
    Document   : commonMensajeAlumnoNomina
...
<html lang="es">
    ...
    <body class="inner-body"> 
        <form id="alumno-nomina-form" action="#" method="post" accept-charset="UTF-8">
            <div id="table-div">
                            ...
                            <s:iterator value="#session.genericSession.getWorkSession(key).alumnoList" status="row">
                                <tr>
                                    <td style="width: 15%; text-align: right"><a
                                            onClick="addAlumno(<s:property value="#row.count -1"/>); return false;"
