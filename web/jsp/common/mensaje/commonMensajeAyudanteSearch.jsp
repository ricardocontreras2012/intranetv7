<%--
    Document   : commonMensajeAyudanteSearch
...
<html lang="es">
    <head>
        ...
        <title>Búsqueda de Ayudantes</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/mensaje/commonMensajeAyudanteSearch-3.0.3.js"></script>
    </head>
    <body class="inner-body">        

        <div class="title-div">&nbsp;&nbsp;&nbsp;<s:text name="label.title.search.ayudante"/></div>
        ...
        <div class="container container-menu">
            <div class="row">
                <div id="justified-button-bar" class="col-lg-12">
                    <div class="btn-group">
                        <div class="btn-group">
                            <button id="search-button" title="Iniciar la Búsqueda" type="button" class="btn btn-light"  onclick="searchMessageAyudante(); return false;">
                                <span class="fa fa-search"></span>&nbsp; <span class="hidden-xs"><s:text name="label.button.search"/></span>
                            </button>
                        </div>
                        <div class="btn-group">
                            <button id="clear-button" title="Limpiar Datos" type="button" class="btn btn-light"  onclick="otroAyudante(); return false;">
        ...
        <form id="ayudante-search-form" action="#" method="post" accept-charset="UTF-8">
            <div class="form-row">
                <div class="col-md-1">
