<%--
    Document   : commonMensajeProfesorLista
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/mensaje/commonMensajeProfesorLista-3.0.2.js"></script>
    </head>    
    <body class="inner-body"> 
        ...
        <div class="container container-menu">
            <div class="row">
                <div id="justified-button-bar" class="col-lg-12">
                    <div class="btn-group">
                        <div class="btn-group">
                            <button id="search-button" title="Buscar" type="button" class="btn btn-light"  onClick="otroProfesor();return false;">
        ...
        <form id="profesor-lista-form" action="#" method="post" accept-charset="UTF-8">
            <div>
            ...
            <div id="hidden-input-div">
                ...
                <input id="actionCall" name="actionCall" type="hidden" value="CommonMensajeAddProfesor"/>
                ...
                <input type="hidden" id="nombreLista" name="nombreLista" value="Profesor(s)"/>
