<%--
    Document   : commonMensajeReceivedMessages
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/mensaje/commonMensajeReceivedMessages-3.0.5.js"></script>
    </head>
    <body class="inner-body">
        <form id="received-messages-form" action="#" accept-charset="UTF-8">  
            <div id="table-div" style="overflow-x: hidden">
                <table id="received-table" class="table table-striped table-bordered dataTable" style="width:100%">
                </table>
            </div>
        ...
        <form id="nombresColumnas" action="#" accept-charset="UTF-8">
            <input type="hidden" id="sentBy" name="sentBy" value="<s:text name="label.sentBy"/>" />
