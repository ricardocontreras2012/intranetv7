<%--
    Document   : commonMensajeAyudanteNomina
...
<html lang="es">
    ...
    <body class="inner-body"> 
        <form id="ayudante-nomina-form" action="#" method="post" accept-charset="UTF-8">
                    ...
                    <table id="search-table" class="table table-striped table-bordered dataTable">
                        ...
                        <tbody>
                            <s:iterator value="#session.genericSession.getWorkSession(key).ayudanteList" status="row">
                                <tr>
                                    <td style="width: 15%; text-align: right"><a onClick="addAyudante(<s:property value="#row.count -1"/>); return false;"
                                                                                 id="ayudante_<s:property value="#row.count -1"/>"><s:property value="ayuRut"/>-<s:property value="ayuDv"/></a></td>
