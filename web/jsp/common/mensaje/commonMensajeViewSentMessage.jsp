<%--
    Document   : commonMensajeViewSentMessage
    Created on : 07-08-2009, 04:02:04 PM
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/mensaje/commonMensajeViewSentMessage-3.0.3.js"></script>
    </head>
    <body class="inner-body">
        ...
        <form id="view-sent-message-form" action="#" accept-charset="UTF-8">
            <table class="table">
                <tr>
                ...
                <tr>
                    ...
                    <td><s:property
                            value="#session.genericSession.getWorkSession(key).currentMsg.msgPara"/></td>
                </tr>
                <tr>
            ...
            <div id="hidden-input-sent-div">
                ...
                <input type="hidden" id="posDummy" name="pos" value="<s:property value="pos"/>"/>
