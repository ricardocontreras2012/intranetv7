<%--
    Document   : commonMensajeAyudanteLista
...
<html lang="es">
    <head>
        ...
        <title>Lista de Ayudantes</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/mensaje/commonMensajeAyudanteLista-3.0.2.js"></script>
    </head>    
    <body class="inner-body"> 
        ...
        <div class="container container-menu">
            <div class="row">
                <div id="justified-button-bar" class="col-lg-12">
                    <div class="btn-group">
                        <div class="btn-group">
                            <button id="search-button" title="Buscar" type="button" class="btn btn-light"  onClick="otroAyudante()();return false;">
        ...
        <form id="ayudante-lista-form" action="#" method="post" accept-charset="UTF-8">
            <div>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" name="ck_<s:property value="#row.count -1"/>" id="ck_<s:property value="#row.count -1"/>"
                                   value="<s:property value="id"/>" class="form-group-sm" checked="checked"/>&nbsp;<s:property
                                value="value"/>
                        </td>
                    </tr>
                </s:iterator>
            ...
            <div id="hidden-input-div">
                ...
                <input id="actionCall" name="actionCall" type="hidden" value="CommonMensajeAddAyudante"/>
                ...
                <input type="hidden" id="nombreLista" name="nombreLista" value="Ayudante(s)"/>
