<%--
    Document   : commonPracticaActaEnable.jsp
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/practica/commonPracticaActaEnable-3.0.0.js"></script>
    </head>
    <body>
        <div class="container-fluid">
            <div class="title-div">
                Acta <s:property value="#session.genericSession.getWorkSession(key).practicaList.get(0).asignatura.asiNom"/>
            </div>
