<%--
    Document   : commonReporteResumenListaCursoAgnoSem
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/common/reporte/commonReporteResumenListaCursoAgnoSem-3.0.0.js"></script>
    </head>
