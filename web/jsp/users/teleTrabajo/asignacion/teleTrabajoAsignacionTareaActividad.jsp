<%-- 
    Document   : teleTrabajoAsignacionTareaActividad
...
<html lang="es">
    <head>
        ...
        <title>Formulario de Agregar Tareas a Actividad</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/teleTrabajo/asignacion/teleTrabajoAsignacionTareaActividad-1.0.2.js"></script>
    </head>
    <body class="inner-body">
        ...
        <div class="container container-menu">
            <div class="row">
                <div id="justified-button-bar" class="col-lg-12">
                    <div class="btn-group">
                        <div class="btn-group">
                            <button id="add-button" title="Tarea" type="button" class="btn btn-light" >
                                <span class="fa fa-plus"></span>&nbsp; <span class="hidden-xs">Tarea</span>
                            </button>
                        </div>
                        <div class="btn-group">
        ...
        <form id="tareas-form" action="#" method="post" accept-charset="UTF-8">
