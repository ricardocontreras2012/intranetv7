<%--
    Document   : directorEdContinuaIdBienvenida
...
<html lang="es">
    <head>
        ...
        <title>HomePage Director Educación Contínua</title>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a href="#" class="dropdown-item" onclick="executeActionNested('CommonCursoGetCarreras?key=<s:property value="key"/>&actionName=CommonCursoGetCursosxAgnoSemEncuesta&actionCall=CommonProfesorGetEncuesta')"><s:text
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeActionNested('CommonCursoGetCarreras?key=<s:property value="key"/>&actionName=CommonActaGetActasCarrera');">
                                <s:text name="label.menu.acta.estado"/></a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
