<%--
    Document   : subDirectorDepartamentoIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-SubDirector Departamento</title>
    ...
    <body class="inner-body">
        ...
        <div class="ui-layout-west">
            <div class="menu">
                <div class="leftsidebar" style="margin-top: -2px">
                    ...
                    <div id="mis-cursos" style="width:130px; height:126px; margin-left:6px">
                        <ul class="flyout">
                            ...
                            <li><a onclick="executeActionNested('CommonCursoGetCarreras?key=<s:property value="key"/>&actionName=CommonCursoGetCursosxAgnoSemEncuesta&actionCall=CommonProfesorGetEncuesta')"><s:text
