<%--
    Document   : formacionIntegralIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Formación Integral</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/formacionIntegral/id/formacionIntegralIdHomePage-3.0.0.js"></script>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarPrincipal">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">                            
                            <a href="#" class="dropdown-item" onclick="executeActionNested('CommonAgnoSem?key=<s:property value="key"/>&actionName=FormacionIntegralGetCursos')">
                                FAE/DERECHO</a>                           
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeActionNested('CommonAgnoSem?key=<s:property value="key"/>&actionName=FormacionIntegralGetCursosNomina&actionCall=CommonCursoGetListaCurso')">
