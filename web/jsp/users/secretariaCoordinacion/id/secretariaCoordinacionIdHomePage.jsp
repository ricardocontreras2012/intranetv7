<%--
    Document   : secretariaCoordinacionIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Secretaria de Coordinación</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/secretariaCoordinacion/id/secretariaCoordinacionIdHomePage-3.0.0.js"></script>
    </head>
    <body>
