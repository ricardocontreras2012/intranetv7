<%--
    Document   : directorDepartamentoIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Director de Departamento</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/directorDepartamento/id/directorDepartamentoIdHomePage-3.0.0.js"></script>
    </head>
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a href="#" class="dropdown-item" onclick="executeActionNested('CommonCursoGetCarreras?key=<s:property value="key"/>&actionName=CommonCursoGetCursosxAgnoSemEncuesta')"><s:text 
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a href="#" class="dropdown-item" id="mensajes-li">
