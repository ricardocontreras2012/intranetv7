...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Area Apoyo</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/areaApoyo/id/areaApoyoIdHomePage-3.0.0.js"></script>
    </head>
    <body>
