<%--
    Document   : apoyoIdHomePage
    Created on : 07-05-2019, 08:06:46 PM
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Apoyo</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/apoyo/id/apoyoIdHomePage-3.0.0.js"></script>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarPrincipal">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><s:text name="label.menu.mis.actividades"/></a>
        ...
        <form id="consulta-form" action="#" method="post">
