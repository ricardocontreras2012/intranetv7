<%--
    Document   : egresadoEstudiosViewEstudio
    Created on : 03-09-2014, 16:40:42
...
<html lang="es">
    <head>
        ...
        <title>Formulario de Edición de Estudio</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/egresado/estudios/egresadoEstudiosViewEstudio-3.0.0.js"></script>
    </head>
            ...
            <div style="width: 100%; overflow: hidden">
                <form id="egresado-form" action="#" class="form-horizontal">
                        ...
                        <div class="form-group" id="otraInstitucionDiv">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="otraInstitucion" name="otraInstitucion" class="form-control" placeholder="Nombre de la Institución"
                                       value="<s:property value="#session.egresadoSession.fichaEstudio.festOtraInstitucion"/>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="nombreEstudio" name="nombreEstudio" class="form-control"
                                       value="<s:property value="#session.egresadoSession.fichaEstudio.festNombreEstudio"/>" />
                            </div>
                        </div>
                    ...
                    <div id="hidden-input-div">
                        <input type="hidden" id="correl" name="correl" value="<s:property value="#session.egresadoSession.fichaEstudio.festCorrel"/>"/>
                        <input type="hidden" id="keyDummy" name="keyDummy" value="<s:property value="key"/>"/>
                        <input type="hidden" id="paisDummy" name="paisDummy" value="<s:property value="#ssession.egresadoSession.fichaEstudio.pais.paiCod"/>"/>
                        <input type="hidden" id="institucionEducacionalDummy" name="institucionEducacionalDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.institucionEducacional.ineId"/>"/>
                        <input type="hidden" id="tipoEstudioDummy" name="tipoEstudioDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.testudio.testId"/>"/>
                        <input type="hidden" id="desdeAgnoDummy" name="desdeAgnoDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.festDesdeAgno"/>"/>
                        <input type="hidden" id="desdeMesDummy" name="desdeMesDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.festDesdeMes"/>"/>
                        <input type="hidden" id="hastaAgnoDummy" name="hastaAgnoDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.festHastaAgno"/>"/>
                        <input type="hidden" id="hastaMesDummy" name="hastaMesDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.festHastaMes"/>"/>
                        <input type="hidden" id="estadoEstudioDummy" name="estadoEstudioDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.estadoEstudio.eestId"/>"/>
                        <input type="hidden" id="areaEstudioDummy" name="areaEstudioDummy" value="<s:property value="#session.egresadoSession.fichaEstudio.areaEstudio.aestId"/>"/>
                    </div>
                </form>
            </div>
        </div>
