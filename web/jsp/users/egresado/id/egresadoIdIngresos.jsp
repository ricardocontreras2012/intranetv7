<%--
    Document   : egresadoIdIngresos
    Created on : 25-01-2012, 07:05:20 PM
...
<html lang="es">
    <head>
        ...
        <title>Lista de Carreras del Egresado</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/egresado/id/egresadoIdIngresos-2.0.0.js"></script>
    </head>
