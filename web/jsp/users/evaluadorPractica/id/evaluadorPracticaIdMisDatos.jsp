<%--
    Document   : evaluadorPracticaIdMisDatos
...
<html lang="es">
    <head>
        ...
        <title>Mis Datos Personales Evaluador Practica</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/evaluadorPractica/id/evaluadorPracticaIdMisDatos-2.0.0.js"></script>
    </head>
