...
<html lang="es">
    <head>
        ...
        <title>Calendario Mencion - Profesor</title>
    ...
    <body class="inner-body">
        <div class="title-div">
            <s:text name="label.menu.calendario"/> <s:text name="label.title.carreras"/>
        </div>
                        ...
                        <tr>
                            <td>
                                <s:iterator value="#session.genericSession.profesorSession.mencionInfoIntranetProfesorViewList" status="row">
                                    <p><a onclick="showCalendarioProfesor('<s:property value="miniUrlCalendarioAct"/>');"><s:property value="nombreMencion"/></a></p>
                                    </s:iterator>
                            </td>
                        </tr>
                    </tbody>
