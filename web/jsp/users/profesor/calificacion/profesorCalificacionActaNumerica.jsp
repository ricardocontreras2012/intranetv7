<%--
    Document   : profesorCalificacionActaNumerica
...
<html lang="es">
    <head>
        ...
        <title>Formulario de Emisión de Acta con Calificación Numérica</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/profesor/calificacion/profesorCalificacionActaNumerica-3.0.9.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            <s:text name="label.title.acta"/> <s:property value="#session.genericSession.getWorkSession(key).curso.nombreCorto"/>
        </div>
        ...
        <form id="acta-form" onsubmit="return habilita()" action="#" method="post">
            ...
            <div id="hidden-input-div">
                ...
                <input type="hidden" id="contentDisposition" name="contentDisposition"
                       value='attachment;filename="NOTAS_FINALES_<s:property value="#session.genericSession.getWorkSession(key).curso.nombreFull"/>.pdf"'/>
