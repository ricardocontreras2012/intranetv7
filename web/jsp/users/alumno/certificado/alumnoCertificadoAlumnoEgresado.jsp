<%-- 
    Document   : alumnoCertificadoAlumnoEgresado
...
<html lang="es">
    <head>
        ...
        <title>Certificación de Alumno Egresado</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        ...
        src="/intranetv7/js/local/users/alumno/certificado/alumnoCertificadoAlumnoEgresado-3.0.5.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            ALUMNO EGRESADO->SELECCIONE TRÁMITE
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table-striped">
                            <tr style="padding-top: 10px"><td style="padding-right: 25px;">Tipo de Certificado</td><td>Alumno Egresado</td></tr>
