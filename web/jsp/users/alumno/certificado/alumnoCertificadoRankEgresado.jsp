<%-- 
    Document   : alumnoCertificadoRankEgresado
    Created on : 22-07-2023, 12:43:40
    Author     : Ricardo
--%>
<!DOCTYPE html>
...
<html lang="es">
    <head>
        ...
        <title>Certificación de Ranking Egresado</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        ...
        src="/intranetv7/js/local/users/alumno/certificado/alumnoCertificadoRankEgresado-3.0.5.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            RANKING EGRESADO->SELECCIONE TRÁMITE
        </div>
        ...
        <s:form id="certificacion-form" action="#" method="post" theme="bootstrap">
            ...
            <s:if test="#session.alumnoSession.rankMencion != null">
                <p></p>
                <p></p>
                <p>Seleccione el criterio con el se emitirá el certificado</p>
                <p> <input type="radio" id="rank" name="rank" value="0">La carrera de ingreso:&nbsp;&nbsp;<s:property value="#session.alumnoSession.rank"/></p>
                <p> <input type="radio" id="rank" name="rank" value="1">La mención de ingreso:&nbsp;&nbsp;<s:property value="#session.alumnoSession.rankMencion"/></p>
                </s:if>
                <s:else>
                <div hidden>
                    <input type="radio" id="rank" name="rank" value="0" checked>
                </div>
            </s:else> 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table-striped">
                            <tr style="padding-top: 10px"><td>Tipo de Certificado</td><td>Ranking Egresado</td></tr>
                            <tr style="padding-top: 10px"><td>Trámite</td><td><div id="tram-div"></div></td></tr>
                            <tr style="padding-top: 10px"><td>Glosa adicional solicitada</td><td><div id="glosa-div"></div></td></tr>
                        </table> 
                    </div>
