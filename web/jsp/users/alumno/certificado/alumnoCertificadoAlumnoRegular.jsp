...
<html lang="es">
    <head>
        ...
        <title>Certificación de Alumno Regular</title>
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/alumno/certificado/alumnoCertificadoAlumnoRegular-3.0.6.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            ALUMNO REGULAR->SELECCIONE TRÁMITE
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <table class="table-striped">
                            <tr style="padding: 10px"><td style="padding-right: 25px;">Tipo de Certificado</td><td>Alumno Regular</td></tr>
                            <tr style="padding: 10px"><td style="padding-right: 25px;">Trámite</td><td><div id="tram-div"></div></td></tr>
                            <tr style="padding: 10px"><td style="padding-right: 25px;">Glosa adicional solicitada</td><td><div id="glosa-div"></div></td></tr>
                        </table> 
                    </div>
