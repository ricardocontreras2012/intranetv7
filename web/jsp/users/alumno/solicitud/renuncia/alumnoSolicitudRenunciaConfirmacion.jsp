<%--
    Document   : alumnoSolicitudRenunciaConfirmacion
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/alumno/solicitud/renuncia/alumnoSolicitudRenunciaConfirmacion-3.0.0.js"></script>
    </head>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="msgModalLabel">Renuncia a la Carrera</h5>
                            ...
                            <div class="modal-body">
                                <div id="new-evaluacion-div">
                                    <p>¿Desea solicitar renuncia a la carrera?</p>
                                    <p></p>
