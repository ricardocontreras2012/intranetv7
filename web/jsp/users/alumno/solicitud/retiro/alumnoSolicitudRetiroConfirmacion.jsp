<%--
    Document   : alumnoSolicitudRetiroConfirmacion
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/alumno/solicitud/retiro/alumnoSolicitudRetiroConfirmacion-3.0.0.js"></script>
    </head>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="msgModalLabel">Retiro Temporal sin Expresión de Causa</h5>
                            ...
                            <div class="modal-body">
                                <div id="new-evaluacion-div">
                                    <p>¿Desea solicitar retiro temporal?</p>
                                    <p></p>
