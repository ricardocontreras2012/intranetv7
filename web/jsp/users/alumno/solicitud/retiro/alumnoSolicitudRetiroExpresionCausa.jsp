...
<html lang="es">
    <head>
        <meta charset="utf-8"><meta http-equiv="Content-Security-Policy" content="default-src * 'self' 'unsafe-eval'; script-src * 'self'; connect-src * 'unsafe-inline'; img-src * data: blob: 'unsafe-inline'; frame-src *; style-src * 'unsafe-inline';">
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/alumno/solicitud/retiro/alumnoSolicitudRetiroExpresionCausa-3.0.1.js"></script>
    </head>
        ...
        <div class="container-fluid">
            ...
            <form id="causa-form" action="#" method="post" class="form-horizontal" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <s:file label="File" name="upload" id="upload" multiple="multiple"></s:file>
                </div>
