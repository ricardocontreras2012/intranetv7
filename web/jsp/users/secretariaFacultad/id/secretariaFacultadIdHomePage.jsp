<%--
    Document   : secretariaFacultadIdHomePage
...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/secretariaFacultad/id/secretariaFacultadIdHomePage-3.0.0.js"></script>
    </head>
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeAction('CommonEmailEnableForm')"><s:text
                                    name="label.menu.email"/></a>
