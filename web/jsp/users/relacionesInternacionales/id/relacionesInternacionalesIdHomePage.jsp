<%--
    Document   : relacionesInternacionalesIdHomePage
    Created on : 18-07-2010, 08:06:46 PM
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Relaciones Internacionales</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/relacionesInternacionales/id/relacionesInternacionalesIdHomePage-3.0.0.js"></script>
    </head>
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeAction('ConsultaMisDatosGetMisDatos')">
