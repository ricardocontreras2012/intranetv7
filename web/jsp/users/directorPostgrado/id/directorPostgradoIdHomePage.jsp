...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Director Postgrado</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/directorPostgrado/id/directorPostgradoIdHomePage-3.0.0.js"></script>
    </head>
    <body>
