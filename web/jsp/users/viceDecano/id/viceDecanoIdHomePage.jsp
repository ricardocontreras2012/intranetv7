...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-ViceDecano</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/viceDecano/id/viceDecanoIdHomePage-3.0.0.js"></script>
    </head>
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><s:text name="label.menu.utilidades"/></a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a href="#" class="dropdown-item" onclick="executeAction('CommonSalaEnable')"><s:text name="label.menu.consulta.salas"/></a>
                            <a href="#" class="dropdown-item" id="mensajes-li"></a>
                        </div>
                    </li>
                    
                    <%--li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Solicitudes....</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">                            
                            <a href="#" class="dropdown-item" onclick="executeAction('CommonSolicitudGetSolicitudes');">Reincorporación</a>
                            <a href="#" class="dropdown-item" onclick="executeAction('CommonSolicitudGetSolicitudes');">Matrículas</a>                            
                        </div>
                    </li--%>
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link" onclick="executeActionNested('CommonSetAgnoSemAct?key=<s:property value="key"/>&actionName=CommonExportControlAsistencia')">Control Asistencia</a>
                    </li>
                </ul>
        ...
        <form id="vice-decano-form" action="#" method="post">
