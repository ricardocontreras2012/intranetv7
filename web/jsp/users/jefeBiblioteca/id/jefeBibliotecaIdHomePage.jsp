<%--
    Document   : jefeBibliotecaIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Jefe Biblioteca</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/jefeBiblioteca/id/jefeBibliotecaIdHomePage-3.0.0.js"></script>
    </head>
    <body>
