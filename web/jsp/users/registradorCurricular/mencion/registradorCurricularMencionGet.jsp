<%--
    Document   : registradorCurricularMencionGet
...
<html lang="es">
    <head>
        ...
        src="/intranetv7/js/local/users/registradorCurricular/mencion/registradorCurricularMencionGet-3.0.1.js"></script>
    </head>
                ...
                <table id="carreras-table" class="table table-striped">
                    ...
                    <tbody>
                        <s:iterator value="#session.genericSession.getWorkSession(key).mencionList" status="row">
                            <tr>                                
                                <td><a id="carrera_<s:property value="#row.count -1"/>"><s:property value="id.menCodCar"/>&nbsp;<s:property value="id.menCodMen"/></a></td>
                                <td><a id="carrera_<s:property value="#row.count -1"/>"><s:property value="getNombreCarreraFull()"/></a></td>
                            </tr>
                        </s:iterator>
                    </tbody>
                </table>
