...
<html lang="es">
    <head>
        ...
        <title>Menu Curso Intranet-Ayudante</title>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSubNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link" onclick="executeMenuCursoAction('AyudanteHorarioComun')">Horario Común</a>
                    </li> 
                </ul>
            </div>
        </nav>
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>&#9;<a onclick="executeGetMaterial('CommonMaterialEnableConsola', 'AY');">Mi</a></p>
                        <p>&#9;<a onclick="executeGetMaterial('CommonMaterialEnableConsola', 'PR');">Profesor</a></p>
