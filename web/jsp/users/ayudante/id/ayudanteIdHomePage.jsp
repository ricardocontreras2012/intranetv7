<%--
    Document   : ayudanteIdHomePage
    Created on : 06-06-2009, 10:15:58 AM
...
<html lang="es">
    <head>
        ...
        <title>HomePage de Intranet-Ayudante</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/ayudante/id/ayudanteIdHomePage-3.0.0.js"></script>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarPrincipal">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeActionParm('CommonHorarioGetHorario?id=AY')">
                                <s:text name="label.horario"/></a>
                            <a href="#" class="dropdown-item" onclick="executeAction('ProfesorEncuestaGetCargaHistoricaAyudante')"><s:text
