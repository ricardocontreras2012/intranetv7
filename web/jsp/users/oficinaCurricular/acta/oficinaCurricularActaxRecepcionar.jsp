<%--
    Document   :oficinaCurricularActaxRecepcionar
    Created on : 13-11-2010, 10:29:06 PM
...
<html lang="es">
    <head>
        ...
        <title>Actas x Recepcionar</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/oficinaCurricular/acta/oficinaCurricularActaxRecepcionar-3.0.0.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            <s:text name="label.title.acta.recepcionar"/>
        </div>
                ...
                <div class="row">
                    <div id="justified-button-bar" class="col-lg-12">
                        <div class="btn-group">
                            ...
                            <div class="btn-group">
                                <button id="print-button" title="Recepcionar" type="button" class="btn btn-light" >
                                    <span class="fa fa-download"></span>&nbsp; <span class="hidden-xs"><s:text name="label.button.recepcionar"/></span>
                                </button>
                            </div>
                        </div>
                    </div>
