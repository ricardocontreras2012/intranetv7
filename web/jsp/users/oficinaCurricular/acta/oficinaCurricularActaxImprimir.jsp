...
<html lang="es">
    <head>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/oficinaCurricular/acta/oficinaCurricularActaxImprimir-3.0.2.js"></script>
    </head>
    <body class="inner-body">
        <div class="title-div">
            <s:text name="label.title.acta.imprimir"/>
        </div>
