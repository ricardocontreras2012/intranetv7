...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Jefe de Area</title>
        ...
        src="/intranetv7/js/local/users/jefeArea/id/jefeAreaIdHomePage-3.0.0.js"></script>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarPrincipal">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeActionNested('JefeAreaGetCursosReporte?key=<s:property value="key"/>');">
                                <s:text name="label.menu.reportes"/></a>
                                
                            <a href="#" class="dropdown-item" onclick="executeActionNested('JefeAreaGetCursosEncuesta?tipo=I&key=<s:property value="key"/>');">
                                <s:text name="label.menu.encuestas"/></a>
                                
                            <a href="#" class="dropdown-item" onclick="executeActionNested('JefeAreaGetCursosEncuesta?tipo=V&key=<s:property value="key"/>');">
                                 Encuestas Intermedias</a>  
                                
                            <a href="#" class="dropdown-item" onclick="executeActionNested('JefeAreaReportesGetResumen?key=<s:property value="key"/>');">
                                <s:text  name="label.menu.resumen.reportes"/></a>
                            <a href="#" class="dropdown-item" onclick="executeActionNested('JefeAreaMaterialesGetResumen?key=<s:property value="key"/>');"><s:text
