...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Asistente Social</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/asistente/id/asistenteIdHomePage-3.0.0.js"></script>
    </head>
    <body>
