<%--
    Document   : titulosyGradosIdMisDatos
    Created on : 06-05-2011, 06:32:41 PM
...
<html lang="es">
    <head>
        ...
        <title>Datos Personales de Usuarios de Títulos y Grados</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/titulosyGrados/id/titulosyGradosIdMisDatos-3.0.0.js"></script>
    </head>
                        ...
                        <td style="width: 75%">
                            <table cellspacing="3" cellpadding="5">
                                <tr>
                                    ...
                                    <td><s:property
                                            value="#session.genericSession.titulosyGradosSession.titulosyGrados.tygPaterno"/></td>
                                </tr>
                                <tr>
                                    <td><s:text name="label.materno"/></td>
                                    <td><s:property
                                            value="#session.genericSession.titulosyGradosSession.titulosyGrados.tygMaterno"/></td>
                                </tr>
                                <tr>
                                    <td><s:text name="label.name"/></td>
                                    <td><s:property
                                            value="#session.genericSession.titulosyGradosSession.titulosyGrados.tygNombre"/></td>
                                </tr>
                                <tr>
                                    <td><label for="email"><s:text name="label.email"/></label></td>
                                    <td>
                                        <input type="text" id="email" name="email" size="57"
                                               value="<s:property value="#session.genericSession.titulosyGradosSession.titulosyGrados.tygEmail"/>"/>
                                    </td>
                                </tr>
                            </table>
