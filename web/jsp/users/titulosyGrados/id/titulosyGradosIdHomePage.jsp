<%--
    Document   : titulosyGradosIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Titulos y Grados</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/titulosyGrados/id/titulosyGradosIdHomePage-3.0.0.js"></script>
    </head>
    <body>
                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeAction('TitulosyGradosMisDatosGetMisDatos')"><s:text
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Alumno</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeSimpleAction('CommonAlumnoSearchEnable?actionCall=CommonAlumnoRecordEnable&actionNested=CommonAlumnoGetRecord&typeSearch=F&key=<s:property value="key"/>');">Consulta
                            </a>  
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Nómina/STD</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeAction('TitulosyGradosNominaSearch')">Consultar</a>
                            <a href="#" class="dropdown-item" onclick="executeAction('TitulosyGradosNominaNew')">Nueva</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Estadística</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a href="#" class="dropdown-item" onclick="executeAction('CommonEstadisticaEnableAgnoForm')"><s:text
                                    name="label.menu.consulta.titulados"/></a>
                        </div>
                    </li>
                </ul>
        ...
        <form id="tyg-form" action="#" method="post">
