<%--
    Document   : consultaIdMisDatos
    Created on : 18-07-2010, 10:15:35 PM
...
<html lang="es">
    <head>
        ...
        <title>Mis Datos Personales Usuario Consulta</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/consulta/id/consultaIdMisDatos-2.0.0.js"></script>
    </head>
