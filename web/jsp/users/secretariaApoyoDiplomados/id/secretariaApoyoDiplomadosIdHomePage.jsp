<%--
    Document   : secretariaApoyoDiplomadosIdHomePage
...
<html lang="es">
    <head>
        ...
        <title>HomePage Intranet-Secretaria Apoyo a Diplomados</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/users/secretariaApoyoDiplomados/id/secretariaApoyoDiplomadosIdHomePage-3.0.0.js"></script>
    </head>
    <body>
            ...
            <div class="collapse navbar-collapse" id="navbarPrincipal">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Certificados</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
