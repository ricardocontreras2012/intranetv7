...
<html lang="es">
    <head>
        ...
        <title>Aviso: Mensaje de Error</title>
        ...
        <script type="text/javascript" src="/intranetv7/js/local/message/messageError-3.0.0.js"></script>
    </head>
    <body class="inner-body">
        <div id="msg-div" title="<s:text name="message.title.msg"/>"><s:actionerror cssClass="actionError"/></div>
    </body>
</html>
