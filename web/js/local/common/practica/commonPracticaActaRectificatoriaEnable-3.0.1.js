...
function buscar()
{
    $("#acta-form").attr("action", "CommonPracticaActaRectificatoriaEnable").attr("target", "_self").submit();
}
...
function emitirActaAceptar() {
    ...
    $("#acta-form").attr("action", "CommonPracticaActaRectificatoriaEmitir").attr("target", "_self").submit();
}
