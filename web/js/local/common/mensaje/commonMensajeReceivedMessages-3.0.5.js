...
$(document).ready(function () {
    ...
    const dt = $("#received-table").DataTable({
        ...
        columnDefs: [
            ...
            {
                targets: 5,
                data: "mensaje.formattedFullDate",
                title: $("#date").val(),
                orderable: true,
                createdCell: function (td, cellData, rowData, row, col) {
                    $(td).css('text-align', 'center');
