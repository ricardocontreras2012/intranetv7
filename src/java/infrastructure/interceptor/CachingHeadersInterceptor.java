 ...
 */
/**
 * Interceptor que agrega cabeceras HTTP para evitar el almacenamiento en caché
 * de las respuestas en el navegador del usuario. Configura cabeceras como
 * "Cache-control", "Pragma" y "Expires" para asegurar que las respuestas no
 * sean almacenadas en caché.
 *
...
public final class CachingHeadersInterceptor extends AbstractInterceptor {
    ...
    /**
     * Este método intercepta la ejecución de la acción y configura las
     * cabeceras de la respuesta HTTP para evitar el almacenamiento en caché en
     * el navegador. Si la acción no está en la lista de acciones excluidas, se
     * agregan las cabeceras correspondientes.
     *
     * @param invocation El objeto que contiene la información sobre la acción
     * invocada.
     * @return El resultado de la acción, que se continúa con la ejecución
     * después de agregar las cabeceras.
    ...
    /**
     * Método que obtiene el conjunto de acciones excluidas de la configuración
     * de cabeceras.
     *
    ...
    /**
     * Establece las acciones para las cuales no se aplicarán las cabeceras de
     * caché. Las acciones especificadas en la cadena de texto se convierten en
     * un conjunto de acciones excluidas.
     *
     * @param values Cadena de texto con los nombres de las acciones separadas
     * por comas.
     */
