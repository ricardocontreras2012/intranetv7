/*
 * @(#)FlagInscripcionPersistenceViewImpl.java
 *
 ...
 */
public final class FlagInscripcionPersistenceViewImpl extends CrudAbstractDAO<FlagInscripcionView, Long>
        implements FlagInscripcionPersistenceView {
