/*
 * @(#)ActaNominaViewPersistenceImpl.java
 *
 ...
 */
public class ActaNominaViewPersistenceImpl extends CrudAbstractDAO<ActaNominaView, Long>
        implements ActaNominaViewRepository {
