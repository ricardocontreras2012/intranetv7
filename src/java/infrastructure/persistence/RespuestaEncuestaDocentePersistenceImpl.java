 ...
 */
public final class RespuestaEncuestaDocentePersistenceImpl extends CrudAbstractDAO<RespuestaEncuestaDocente, Long> implements RespuestaEncuestaDocenteRepository {
    /**
     * Method description
     *
     * @param aluCar
