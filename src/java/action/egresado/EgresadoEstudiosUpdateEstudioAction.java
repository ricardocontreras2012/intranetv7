/*
 * @(#)EgresadoEstudiosUpdateEstudioAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.egresado;

import service.misdatos.egresado.EgresadoEstudiosUpdateEstudioService;
 ...
 */
public class EgresadoEstudiosUpdateEstudioAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new EgresadoEstudiosUpdateEstudioService().service(this, getGenericSession(), this.correl, this.pais,
