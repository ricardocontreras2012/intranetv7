/*
 * @(#)SaveLaboralAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.egresado;

import service.egresado.SaveLaboralService;
 ...
 */
public class SaveLaboralAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new SaveLaboralService().service(this, getGenericSession(), this.correlAluEmp, this.dependiente,
