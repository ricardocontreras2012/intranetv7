/*
 * @(#)UpdateEstudioAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.egresado;

import service.egresado.UpdateEstudioService;
 ...
 */
public class UpdateEstudioAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new UpdateEstudioService().service(this, getGenericSession(), this.correl, this.pais,
