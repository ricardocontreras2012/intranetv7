/*
 * @(#)UpdateLaboralAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.egresado;

import service.egresado.UpdateLaboralService;
 ...
 */
public class UpdateLaboralAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new UpdateLaboralService().service(this, getGenericSession(), this.correlAluEmp, this.correlFicha, this.dependiente,
