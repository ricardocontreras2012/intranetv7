/*
 * @(#)AlumnoSavePracticaAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.practica.alumno;

import service.practica.alumno.AlumnoSavePracticaService;
 ...
 */
public final class AlumnoSavePracticaAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new AlumnoSavePracticaService().service(this, getGenericSession(), rutEmp, fonoEmp, labor, comuna,
