...
import service.inscripcion.ExportResumenService;


public final class ExportResumenAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {        
        ...
        excelFile = new ExportResumenService().service(getGenericSession(), contentDisposition,
                getKey());
