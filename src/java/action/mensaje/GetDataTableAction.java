...
import service.mensaje.GetDataTableService;
 ...
 */
public final class GetDataTableAction extends ActionCommonSupport{
    ...
    /**
     * Se ejecuta el servicio de GetDataTableService, el cual 
 consigue todos los mensajes del usuario.
    ...
    public String action() throws Exception {
        ...
        String retValue = new GetDataTableService().service(getGenericSession(), getKey(), start, length, searchValue, tipoOrder, nombreDataColumnaActual);
