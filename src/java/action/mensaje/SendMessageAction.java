...
import java.io.File;
import service.mensaje.SendMessageService;
 ...
 */
public final class SendMessageAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new SendMessageService().service(this, getGenericSession(), tipo, subject, messageText, messageHtml, url, upload,
