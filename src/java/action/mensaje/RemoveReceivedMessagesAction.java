/*
 * @(#)RemoveReceivedMessagesAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.mensaje;

import service.mensaje.RemoveReceivedMessagesService;
import infrastructure.support.action.ActionParameterAwareSupport;

/**
 * Procesa el action mapeado del request a la URL
 * CommonMensajeRemoveReceivedMessages
 *
 * @author Ricardo Contreras S.
 * @version 7, 28/05/2012
 */
public final class RemoveReceivedMessagesAction extends ActionParameterAwareSupport {
    ...
    public String action() throws Exception {
        return new RemoveReceivedMessagesService().service(getGenericSession(), getMapParameters(), getKey(), start, length, searchValue, tipoOrder, nombreDataColumnaActual);
    }
