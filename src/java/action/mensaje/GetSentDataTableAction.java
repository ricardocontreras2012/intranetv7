...
import service.mensaje.GetSentDataTableService;
 ...
 * @author Javier
 */
public class GetSentDataTableAction extends ActionCommonSupport  {
    ...
    public String action() throws Exception {
        ...
        String retValue = new GetSentDataTableService().service(getGenericSession(), getKey(), start, length, searchValue, tipoOrder, nombreDataColumnaActual);
