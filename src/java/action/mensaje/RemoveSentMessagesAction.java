/*
 * @(#)RemoveSentMessagesAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.mensaje;

import service.mensaje.RemoveSentMessagesService;
 ...
 */
public final class RemoveSentMessagesAction extends ActionParameterAwareSupport {
    ...
    public String action() throws Exception {
        return new RemoveSentMessagesService().service(getGenericSession(), getMapParameters(), getKey(), start, length, searchValue, tipoOrder, nombreDataColumnaActual);
    }
