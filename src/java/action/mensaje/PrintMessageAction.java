...
import service.mensaje.PrintMessageService;
 ...
 */
public final class PrintMessageAction extends ActionPostValidationSupport {
    ...
    public String action() {
        ...
        try {
            ais = new PrintMessageService().service(getGenericSession(), getPos(), tipo, getKey());
        } catch (Exception e) {
            retValue = "exception";
