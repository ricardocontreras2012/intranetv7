/*
 * @(#)ReceiveListaAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.mensaje;

import service.mensaje.ReceiveListaService;
 ...
 */
public final class ReceiveListaAction extends ActionParameterAwareSupport {
    ...
    public String action() throws Exception {
        return new ReceiveListaService().service(getGenericSession(), getMapParameters(), getKey());
    }
