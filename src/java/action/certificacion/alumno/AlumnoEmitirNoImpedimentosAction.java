...
import service.certificacion.alumno.AlumnoEmitirNoImpedimentosService;
 ...
 */
public class AlumnoEmitirNoImpedimentosAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new AlumnoEmitirNoImpedimentosService().service(correl);
        } catch (Exception e) {
            retValue = "exception";
