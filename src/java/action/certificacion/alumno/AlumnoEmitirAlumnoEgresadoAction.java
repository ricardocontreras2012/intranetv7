...
import service.certificacion.alumno.AlumnoEmitirAlumnoEgresadoService;
 ...
 */
public class AlumnoEmitirAlumnoEgresadoAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new AlumnoEmitirAlumnoEgresadoService().service(correl);
        } catch (Exception e) {
            retValue = "exception";
