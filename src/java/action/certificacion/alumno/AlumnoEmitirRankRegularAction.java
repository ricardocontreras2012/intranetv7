...
import service.certificacion.alumno.AlumnoEmitirRankRegularService;
 ...
 * @author Ricardo
 */
public class AlumnoEmitirRankRegularAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new AlumnoEmitirRankRegularService().service(correl);
        } catch (Exception e) {
            retValue = "exception";
