...
import service.certificacion.alumno.AlumnoEmitirRankEgresadoService;
 ...
 * @author Ricardo
 */
public class AlumnoEmitirRankEgresadoAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new AlumnoEmitirRankEgresadoService().service(correl);
        } catch (Exception e) {
            retValue = "exception";
