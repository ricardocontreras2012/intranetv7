...
import service.alumno.PrintCartolaService;
 ...
 */
public final class PrintCartolaAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new PrintCartolaService().service(getGenericSession(), getKey());
        } catch (Exception e) {
            retValue = "exception";
