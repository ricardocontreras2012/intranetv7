...
import service.certificacion.alumno.AlumnoCertificacionGenerarNoImpedientosService;
...
public class AlumnoCertificacionGenerarNoImpedimentosAction extends ActionCommonSupport {
    ...
    public String action(){                   
        return new AlumnoCertificacionGenerarNoImpedientosService().service(this, getGenericSession(), Manager.getAlumnoSession(sesion), tramite, obs, getKey());       
    }
