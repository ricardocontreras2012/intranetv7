...
import service.alumno.PrintSituacionesService;
 ...
 */
public final class PrintSituacionesAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new PrintSituacionesService().service(getGenericSession(), getKey());
        } catch (Exception e) {
            retValue = "exception";
