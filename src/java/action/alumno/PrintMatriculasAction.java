...
import service.alumno.PrintMatriculasService;
 ...
 */
public final class PrintMatriculasAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        try {
            ais = new PrintMatriculasService().service(getGenericSession(), getKey());
        } catch (Exception e) {
            retValue = "exception";
