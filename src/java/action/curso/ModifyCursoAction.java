...
import service.curso.ModifyCursoService;
 ...
 * @author Ricardo
 */
public class ModifyCursoAction  extends ActionValidationPosSupport {
    ...
    public String action() throws Exception {
        return new ModifyCursoService().service(getGenericSession(), getPos(), cupoId, inicioId, terminoId, diurnoId, vespertinoId, getKey());
    }
