...
import service.curso.GetCursosService;
 ...
 */
public final class GetCursosAction extends ActionCommonSupport {
    ...
    public String action() {
        ...
        return new GetCursosService().service(getGenericSession(), getKey(), keyParent, actionCall);
    }
