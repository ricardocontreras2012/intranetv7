/*
 * @(#)AddDefinicionAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.curso;

import service.curso.AddDefinicionService;
 ...
 */
public final class AddDefinicionAction extends ActionCommonSupport {
    ...
    public String action() throws Exception {
        return new AddDefinicionService().service(getGenericSession(), asign, elect, electivo, coord, secc, cupo, inicio, termino, diurno, vespertino, getKey());
    }
