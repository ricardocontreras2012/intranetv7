...
import service.curso.GetBoletinService;

/**
 *
 * @author Javier Frez V.
 */
public class GetBoletinAction extends ActionValidationAgnoSemSupport {
    ...
    public String action() throws Exception {
        return new GetBoletinService().service(getGenericSession(), getKey(), getPos(), getAgno(), getSem());
    }
