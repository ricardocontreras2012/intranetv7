/*
 * @(#)GetCursoActualAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.curso;

import service.curso.GetCursoActualService;
 ...
 */
public final class GetCursoActualAction extends ActionValidationPosSupport {
    ...
    public String action() throws Exception {  
        return new GetCursoActualService().service(getGenericSession(), getPos(), getKey());
    }
