...
import service.curso.GetEspejosService;
 ...
 * @author Ricardo
 */
public class GetEspejosAction extends ActionValidationAgnoSemSupport {
    ...
    public String action() throws Exception {
        return new GetEspejosService().service(getGenericSession(), getKey(), getPos(), getAgno(), getSem(), actionCall);
    }
