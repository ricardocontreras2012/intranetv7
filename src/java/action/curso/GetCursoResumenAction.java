...
import service.curso.GetCursoResumenService;
 ...
 * @author rcontreras
 */
public class GetCursoResumenAction extends ActionValidationPosSupport {
    ...
    public String action() throws Exception {
        ...
        return new GetCursoResumenService().service(getGenericSession(), getPos(), getKey());
    }
