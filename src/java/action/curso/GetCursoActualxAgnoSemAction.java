/*
 * @(#)GetCursoActualxAgnoSemAction.java
 *
 * Copyright (c) 2025 FAE-USACH
 */
package action.curso;

import service.curso.GetCursoActualxAgnoSemService;
 ...
 */
public final class GetCursoActualxAgnoSemAction extends ActionValidationPosSupport {
