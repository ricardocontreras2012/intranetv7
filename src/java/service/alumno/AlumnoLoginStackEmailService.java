...
public class AlumnoLoginStackEmailService {
    ...
    public static String service(GenericSession genericSession, String key) {
        ...
        return (ContextUtil.getDAO().getScalarPersistence(ActionUtil.getDBUser()).getFlagPasswd(id.getAcaRut(), id.getAcaCodCar(), id.getAcaAgnoIng(), id.getAcaSemIng())==0)?"stack":"email";
