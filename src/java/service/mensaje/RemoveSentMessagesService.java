/*
 * @(#)RemoveSentMessagesService.java
 *
 ...
 */
public final class RemoveSentMessagesService {
    ...
    public String service(GenericSession genericSession, Map<String, String[]> parameters, String key, int start, int length, String searchValue, String tipoOrder, String nombreDataColumnaActual) {
        ...
        IntStream.range(0, ws.getSentMsgs().size())
                ...
                .forEach(i -> {
                    ...
                    mensajeRepo.setDeleteSentMessage(msg);
                });       
        
        commitTransaction();
        ws.setSentMsgs(mensajeRepo.find(genericSession.getRut(), start, length, searchValue, tipoOrder, nombreDataColumnaActual));
