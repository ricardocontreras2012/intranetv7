 ...
 */
public final class ProcessListaService {
    ...
    private void newRootMessage(GenericSession genericSession, String key) {
        ...
        WorkSession ws = genericSession.getWorkSession(key);
        TmensajeDestinoRepository tmensajeDestinoRepo
        ...
        tmensajeDestinoList = (ws.getCursoList() != null && !ws.getCursoList().isEmpty()) || PRIVILEGED_USERS.get(genericSession.getUserType()) != null
                ? tmensajeDestinoRepo.find(genericSession.getUserType())
                : tmensajeDestinoRepo.findSinCursos(genericSession.getUserType());
