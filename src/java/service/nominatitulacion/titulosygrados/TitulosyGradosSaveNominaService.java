/*
 * @(#)TitulosyGradosSaveNominaService.java
 *
 ...
 */
public class TitulosyGradosSaveNominaService {
    ...
    public String service(GenericSession genericSession, Map<String, String[]> parameters, String key) {
        ...
        if (expedienteLogroList != null && !expedienteLogroList.isEmpty()) {
            ...
            ContextUtil.getDAO().getExpedienteNominaRepository(user).saveNomina(ws.getExpedienteLogro().getNomina());
