...
import action.expediente.alumno.AlumnoGetLogrosAction;
 ...
 * @author Ricardo
 */
public class AlumnoGetLogrosService {

    public String service(GenericSession genericSession, String key, AlumnoGetLogrosAction action) {
