/*
 * @(#)CommonEncuestaPrintGroupService.java
 *
 * Copyright (c) Copyright (c) 2023 FAE-USACH
 */
package service.encuesta;

import action.common.CommonEncuestaPrintGroupAction;
 ...
 */
public final class CommonEncuestaPrintGroupService {
     ...
     */
    public InputStream service(CommonEncuestaPrintGroupAction action, GenericSession genericSession,
     ...
     * @throws Exception
     */
    private void printEncuesta(CommonEncuestaPrintGroupAction action, int n, Curso curso,
     ...
     * @return
     */
    private int newPage(CommonEncuestaPrintGroupAction action, Curso curso, Image image,
     ...
     * @return
     */
    private int checkNewPage(int pos, CommonEncuestaPrintGroupAction action, Curso curso,
     ...
     * @throws Exception
     */
    private void putHeader(CommonEncuestaPrintGroupAction action, Curso curso,
