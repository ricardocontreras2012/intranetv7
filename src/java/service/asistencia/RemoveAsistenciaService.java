 ...
 */
public final class RemoveAsistenciaService {
    ...
    public String service(GenericSession genericSession, Map<String, String[]> parameters, String key) {
        ...
        AsistenciaAlumnoRepository asistRepo = ContextUtil.getDAO()
                .getAsistenciaAlumnoRepository(ActionUtil.getDBUser());
        AsistenciaAlumnoNominaRepository asistenciaAlumnoNominaRepo = ContextUtil.getDAO()
        ...
        workSession.getAsistenciaAlumnoList().stream()
                ...
                .forEach(correl -> {
                    asistenciaAlumnoNominaRepo.delete(correl);
                    asistRepo.delete(correl);
                });

        // Actualizamos la lista de AsistenciaAlumno en la sesión
        workSession.setAsistenciaAlumnoList(asistRepo.find(workSession.getCurso()));
