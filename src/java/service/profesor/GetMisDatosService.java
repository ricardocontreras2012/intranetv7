 ...
 */
public final class GetMisDatosService {
    ...
    public String service(GenericSession genericSession, String key) {              
        Profesor profesorAux = ContextUtil.getDAO().getProfesorRepository(ActionUtil.getDBUser()).getMisDatos(genericSession.getRut());
