...
import action.certificacion.alumno.AlumnoGetConfirmacionPagoAction;
 ...
 */
public class AlumnoGetConfirmacionPagoService {

    public String service(AlumnoGetConfirmacionPagoAction action, String transaction, Integer amount, String payment_method, String isApproved) {
        String vRet = "error";
        String obs;
        String estado;
        Integer correl;
