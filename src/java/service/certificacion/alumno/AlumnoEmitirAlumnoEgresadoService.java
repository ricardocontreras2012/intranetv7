 ...
 */
public class AlumnoEmitirAlumnoEgresadoService {
    ...
    private InputStream getInput(
        ...
        try {
            ...
            ScalarRespository scalarRepo
                    = ContextUtil.getDAO().getScalarRepository(user);

            String next = scalarRepo.getSemestrePrevio(ccalId.getCcaAgno(), ccalId.getCcaSem(), aluCar.getId().getAcaCodCar(), aluCar.getAcaCodMen(), aluCar.getAcaCodPlan());
            ...
            if (fecha != null) {
                ...
                if (tramite != null) {
                    ...
                    if (aluCar.getPlan().getMencion().getCarrera().getTcarrera().getTcrCtip() == 200) {
                        int hrsCrono = scalarRepo.getHorasCromoMalla(aluCar.getId().getAcaCodCar(), aluCar.getAcaCodMen(), aluCar.getAcaCodPlan());
