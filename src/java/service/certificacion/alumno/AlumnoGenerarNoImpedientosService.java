...
import action.certificacion.alumno.AlumnoGenerarNoImpedimentosAction;
 ...
 */
public class AlumnoGenerarNoImpedientosService {

    public String service(AlumnoGenerarNoImpedimentosAction action, GenericSession genericSession, AlumnoSession as, Integer codTramite, String obs,
            String key) {
