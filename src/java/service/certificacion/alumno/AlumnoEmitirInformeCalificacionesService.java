/*
 * @(#)AlumnoEmitirInformeCalificacionesService.java
 *
 ...
 */
public final class AlumnoEmitirInformeCalificacionesService {
    ...
    public InputStream getInput(Integer correl, Integer codTramite, String obs, Integer folio, String name, Integer genera, String type, String pagado, String key) {
        ...
        try {
            ...
            AlumnoEmitirInformeCalificacionesService.HeaderFooterPageEvent hf = new AlumnoEmitirInformeCalificacionesService.HeaderFooterPageEvent(folio, codigo, pagado);
            ...
            putFooter(doc, codTramite, obs, facultad, fecha);
            doc.close();
    ...
    private void putFooter(Document doc, Integer codTramite, String obs, Unidad facultad, Date fecha) throws Exception {
