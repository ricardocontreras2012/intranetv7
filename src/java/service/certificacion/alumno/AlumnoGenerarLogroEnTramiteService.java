...
import action.certificacion.alumno.AlumnoGenerarLogroEnTramiteAction;
 ...
 * @author Ricardo
 */
public class AlumnoGenerarLogroEnTramiteService {

    public String service(AlumnoGenerarLogroEnTramiteAction action, GenericSession genericSession, AlumnoSession as, Integer pos, Integer codTramite, String obs,
            String key) {
