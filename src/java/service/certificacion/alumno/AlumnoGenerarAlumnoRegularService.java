...
import action.certificacion.alumno.AlumnoGenerarAlumnoRegularAction;
 ...
 */
public class AlumnoGenerarAlumnoRegularService {

    public String service(AlumnoGenerarAlumnoRegularAction action, GenericSession genericSession, AlumnoSession as, Integer codTramite, Integer periodo, String obs, String key) {
