 ...
 */
public final class TitulosyGradosPrintInformeCalificacionesService {
    ...
    private InputStream getInput(GenericSession genericSession, AluCar aca, Integer folio, String name) throws Exception {
        ...
        TitulosyGradosPrintInformeCalificacionesService.FooterPageEvent hf = new TitulosyGradosPrintInformeCalificacionesService.FooterPageEvent(folio, codigo, "");
