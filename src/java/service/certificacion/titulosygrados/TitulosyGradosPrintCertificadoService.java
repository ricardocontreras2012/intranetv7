package service.certificacion.titulosygrados;
 ...
 * @author Ricardo
 */
public class TitulosyGradosPrintCertificadoService {
    ...
    public ActionInputStreamUtil service(GenericSession genericSession,
        ...
        return new ActionInputStreamUtil(name, description, getInput(genericSession, ws.getAluCar(), exp, name));
    }
    ...
    private InputStream getInput(GenericSession genericSession, AluCar aca, ExpedienteLogro exp, String name) throws Exception {
        ...
        TitulosyGradosPrintCertificadoService.FooterPageEvent hf = new TitulosyGradosPrintCertificadoService.FooterPageEvent(fecha, iniciales);
