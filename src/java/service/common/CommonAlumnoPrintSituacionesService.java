/*
 * @(#)CommonAlumnoPrintSituacionesService.java
 *
 ...
 */
public final class CommonAlumnoPrintSituacionesService extends CommonAlumnoPrintUtil {
    ...
    private static PdfPTable creaTabla() {
        ...
        table.addCell(getPdfPCell("SITUACIÓN", Element.ALIGN_CENTER, myColor));
