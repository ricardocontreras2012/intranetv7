/*
 * @(#)ProfesorEmitirActaNumericaService.java
 *
 ...
 */
public final class ProfesorEmitirActaNumericaService {
        ...
        ws.getNominaActa().stream()
                ...
                .forEach(acta -> {
                    ...
                    if (acta.getAcalFolio() != nActa.get()) {
                        ...
                        actaRepo.putActaEstado(nActa.get(), acta.getAcalAgno(), acta.getAcalSem(), "E");
                    }
                });
