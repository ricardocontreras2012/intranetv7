...
public class ExportActaService {
    ...
    public ActionInputStreamUtil service(GenericSession genericSession, String key) throws Exception {
        ...
        return new ActionInputStreamUtil(fileName, mimeType, getInput(ws));
    }

    private InputStream getInput(WorkSession ws) throws Exception {
        Curso curso = ws.getCurso();
