 ...
 * @author rcontreras
 */
public class SecretariaDocenteImprimirInformeService {
    ...
    private InputStream getInput(GenericSession genericSession, SecretariaSession secreSession,
        ...
        SecretariaDocenteImprimirInformeService.HeaderFooterPageEvent hf = new SecretariaDocenteImprimirInformeService.HeaderFooterPageEvent(folio);
