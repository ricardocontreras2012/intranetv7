 ...
 */
public final class CommonInscripcionResumenExportService {
    ...
    public InputStream service(GenericSession genericSession, String content, String key) throws Exception {
        ...
        XSSFRichTextString textoFacultad = new XSSFRichTextString("hola");
        ...
        XSSFRichTextString textoTitulo = new XSSFRichTextString("LISTA DE INSCRITOS");
