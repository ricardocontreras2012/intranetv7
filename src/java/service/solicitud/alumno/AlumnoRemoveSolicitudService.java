 ...
 */
public final class AlumnoRemoveSolicitudService {
    ...
    public String service(GenericSession genericSession, Map<String, String[]> parameters, String key) {
        ...
        if ("AL".equals(genericSession.getUserType())) {
            SolicitudRepository solicitudRepo = ContextUtil.getDAO().getSolicitudRepository(ActionUtil.getDBUser());
            ...
            IntStream.range(0, solicitudList.size())
                    ...
                    .forEach(solicitud -> {
                        ...
                        solicitudRepo.makeTransient(solicitud);
                    });
