/*
 * @(#)OficinaCurricularRemoveDocumentoService.java
 *
 * Copyright (c) Copyright (c) 2023 FAE-USACH
 */
package service.solicitud.oficinacurricular;
 ...
 */
public final class OficinaCurricularRemoveDocumentoService {
        ...
        if ("OC".equals(genericSession.getUserType()) || "RC".equals(genericSession.getUserType())) {            
            ...
            for (int i = 0; i < solicitudDocumentoList.size(); i++) {
                if (parameters.get("ck_" + i) != null) {
                    ...
                    ContextUtil.getDAO().getSolicitudAttachRepository(user).makeTransient(attach);
                }
            }
