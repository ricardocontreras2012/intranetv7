...
public class PrintListaFotoService {
    ...
    public ActionInputStreamUtil service(GenericSession genericSession, String key) throws Exception {
        ...
        return new ActionInputStreamUtil(name, description, getInput(genericSession, ws, file, curso));
    }

    private InputStream getInput(GenericSession genericSession, WorkSession ws,  String file, Curso curso) throws Exception {
