 ...
 * @author Usach
 */
public class PrintListaAsistenciaService {
    ...
    public ActionInputStreamUtil service(GenericSession genericSession, String key) throws Exception {
        ...
        return new ActionInputStreamUtil(name, description, getInput(genericSession, name, file, curso));
    }

    private InputStream getInput(GenericSession genericSession, String name, String file, Curso curso) throws Exception {
