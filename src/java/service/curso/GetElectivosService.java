...
import action.curso.GetElectivosAction;
 ...
 */
public class GetElectivosService {
   public String service(GenericSession genericSession, String key, Integer pos, Integer agno, Integer sem, GetElectivosAction action) {
